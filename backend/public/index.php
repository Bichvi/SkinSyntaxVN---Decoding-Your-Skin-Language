...
require_once __DIR__ . '/../app/services/HttpJsonClient.php';
require_once __DIR__ . '/../app/services/MailService.php';
require_once __DIR__ . '/../app/controllers/AiChatController.php';
...
switch ($r) {
    ...
    case 'ai_chat_assistant':
        (new AiChatController($pdo))->aiChatAssistant();
        break;

    case 'ai_chat_stream':
        (new AiChatController($pdo))->aiChatStream();
        break;

    case 'ai_chat_commerce':
        (new AiChatController($pdo))->aiChatCommerce();
        break;
    ...
    default:
        // 404
        require_frontend_view('layouts/header.php', ['menuCats' => []]);
        require_frontend_view('404.php', []);
        require_frontend_view('layouts/footer.php', []);
        break;
}
