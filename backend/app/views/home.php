...
$skinSyntaxSignals = [
  ['number' => 'AI RAG', 'label' => 'Phân tích routine & hoạt chất'],
  ...
  <section class="hero-slider-container mb-5" id="heroSlider">
    ...
    <article class="hero-slide active" data-slide="0" style="background-image: url('<?= BASE_URL ?>/assets/images/hero_campaign_ai_skin.png');">
      ...
      <div class="hero-slide-content">
        ...
        <p class="hero-desc">
          Khám phá sản phẩm chuẩn skincare botanical, làm khảo sát da thông minh và nhận gợi ý routine cá nhân hóa bởi AI RAG trên một nền tảng duy nhất.
        </p>
    ...
    <div class="row align-items-center position-relative" style="z-index: 2;">
      <div class="col-lg-7 mb-4 mb-lg-0">
        <span class="badge-pill mb-3" style="display: inline-flex; align-items: center; gap: 6px; background: rgba(255,255,255,0.18); color: #EAF2EC; padding: 6px 14px; border-radius: 999px; font-size: 0.8rem; font-weight: 700;">
          <i class="fas fa-brain text-warning"></i> AI Skincare Engine 2.0
        </span>
        ...
        <p style="color: #EAF2EC; opacity: 0.92; font-size: 1rem; line-height: 1.6; max-width: 620px;" class="mb-4">
          Hệ thống AI RAG phân tích hoạt chất mỹ phẩm, lọc độ phù hợp theo loại da (Dầu / Nhạy cảm / Hỗn hợp) và gợi ý chu trình skincare chuẩn y khoa.
        </p>
        <div class="d-flex flex-wrap gap-3">
          ...
          <a href="<?= BASE_URL ?>/index.php?r=hoso" class="btn btn-outline-light py-3 px-4 fw-bold" style="border-radius: 999px; border: 1.5px solid rgba(255,255,255,0.6);">
          ...
          <div class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
            <div class="d-flex align-items-center gap-2">
              ...
              <div>
                ...
                <small class="text-muted" style="font-size: 0.75rem;">Phân tích theo dữ liệu thực</small>
              </div>
            </div>
            <span class="badge bg-success-subtle text-success fw-bold px-3 py-1 rounded-pill">94% Fit</span>
          </div>

          <div class="d-flex flex-column gap-2 mb-3" style="font-size: 0.85rem;">
            <div class="d-flex justify-content-between">
              <span class="text-muted">Loại da:</span>
              <strong style="color: #1A2F1A;">Da hỗn hợp thiên dầu</strong>
            </div>
            <div class="d-flex justify-content-between">
              <span class="text-muted">Ưu tiên hoạt chất:</span>
              <strong style="color: #215427;">Niacinamide, B5, Hyaluronic</strong>
            </div>
            <div class="d-flex justify-content-between">
              <span class="text-muted">Tình trạng:</span>
              <strong class="text-danger">Mụn nhẹ & Nhạy cảm</strong>
            </div>
          </div>
