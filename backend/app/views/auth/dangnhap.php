    ...
    <div class="row g-0 align-items-stretch">
      ...
      <div class="col-lg-7 bg-white p-4 p-md-5">
        ...
        <div class="row g-2 mb-3">
          <div class="col-6">
            <a class="btn btn-outline-secondary w-100 d-flex align-items-center justify-content-center gap-2 py-2.5 <?= $googleEnabled ? '' : 'disabled' ?>" href="<?= BASE_URL ?>/index.php?r=auth_social&provider=google&oauth_mode=real" style="border-radius: 999px; font-weight: 700; border-color: #E2EADF; color: #1A2F1A; background: #FFF;">
