...
defined('AI_RECOMMENDATION_ENDPOINT') || define('AI_RECOMMENDATION_ENDPOINT', ss_env('AI_RECOMMENDATION_ENDPOINT', 'http://127.0.0.1:5002/api/recommend/explain'));
defined('AI_RECOMMENDATION_TIMEOUT') || define('AI_RECOMMENDATION_TIMEOUT', 20);
defined('AI_HYBRID_RECOMMENDATION_ENDPOINT') || define('AI_HYBRID_RECOMMENDATION_ENDPOINT', ss_env('AI_HYBRID_RECOMMENDATION_ENDPOINT', 'http://127.0.0.1:5002/api/recommend/langchain-rag'));
defined('AI_HYBRID_RECOMMENDATION_TIMEOUT') || define('AI_HYBRID_RECOMMENDATION_TIMEOUT', 30);
defined('AI_LLAMA_INDEX_RECOMMENDATION_ENDPOINT') || define('AI_LLAMA_INDEX_RECOMMENDATION_ENDPOINT', ss_env('AI_LLAMA_INDEX_RECOMMENDATION_ENDPOINT', 'http://127.0.0.1:5002/api/recommend/profile'));
defined('AI_LLAMA_INDEX_RECOMMENDATION_TIMEOUT') || define('AI_LLAMA_INDEX_RECOMMENDATION_TIMEOUT', 35);
defined('AI_PROFILE_RECOMMENDATION_ENDPOINT_BASE') || define('AI_PROFILE_RECOMMENDATION_ENDPOINT_BASE', ss_env('AI_PROFILE_RECOMMENDATION_ENDPOINT_BASE', 'http://127.0.0.1:5002/api/recommend/profile'));
defined('AI_PROFILE_RECOMMENDATION_TIMEOUT') || define('AI_PROFILE_RECOMMENDATION_TIMEOUT', 20);
defined('AI_CHAT_ENDPOINT') || define('AI_CHAT_ENDPOINT', ss_env('AI_CHAT_ENDPOINT', 'http://127.0.0.1:5002/api/chat/auto'));
