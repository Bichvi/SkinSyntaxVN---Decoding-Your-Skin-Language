...
class QuanTriController {
    ...
    private function denyAccess(): void {
        ...
        require_frontend_view('layouts/header.php');
    ...
    private function renderAdmin(string $view, array $data = []): void {
        $scope = $data;
        $scope['notificationCenter'] = $scope['notificationCenter'] ?? $this->buildNotificationCenter();
        require_frontend_view('admin/layouts/header.php', $scope);
        require_frontend_view('admin/' . $view . '.php', $scope);
        require_frontend_view('admin/layouts/footer.php', $scope);
    }
    ...
    private function renderSite(string $view, array $data = []): void {
        $scope = array_merge($data, ['menuCats' => $this->sanPhamModel->menuTree()]);
