  ...
  <div class="auth-card register-card shadow-sm">
    ...
    <form method="post" action="<?= BASE_URL ?>/index.php?r=xulydangky" id="registerForm" novalidate>
      ...
      <div class="register-social-stack">
        ...
        <a class="register-social-btn register-social-btn--google <?= !empty($googleEnabled) ? '' : 'register-social-btn--disabled' ?>" href="<?= BASE_URL ?>/index.php?r=auth_social&provider=google&oauth_mode=real">
